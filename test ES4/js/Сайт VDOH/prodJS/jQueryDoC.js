...
// html код -> .html()
// взять -> $('.items__sub li ul').html(); вывод -> <li>1</li>
// прописать -> $('.items__sub li ul').html('<p>Новый текст</p>'); вывод -> <p>Новый текст</p>
...
// $(".items__sub li"); - выбирает весь массив, все дочерние li в .ul
...
// ФУНКЦИИ -> ===============================================================================================
{
  ...
  function widthAndHeight(element) { // получаем аргумент в вызове функц(btn)
    ...
    $(".items__sub li p").text("Ширина :" + w + "Высота :" + h); // в <p> пропис. ширину и высоту
  }
