...
// html код -> .html()
// взять -> $('.menu-list__sub li ul').html(); вывод -> <li>1</li>
// прописать -> $('.menu-list__sub li ul').html('<p>Новый текст</p>'); вывод -> <p>Новый текст</p>
...
// $(".menu-list__sub li"); - выбирает весь массив, все дочерние li в .ul
...
// ФУНКЦИИ -> ===============================================================================================
{
  ...
  function widthAndHeight(element) { // получаем аргумент в вызове функц(btn)
    ...
    $(".menu-list__sub li p").text("Ширина :" + w + "Высота :" + h); // в <p> пропис. ширину и высоту
  }
